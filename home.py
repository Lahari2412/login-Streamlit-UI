...
def main():
    ...
    def display_candidates():
        col1, col2, col3, col4, col5 = st.columns([2, 3, 4, 3, 5])
        with col1:
            st.markdown("**Select**")
        with col2:
            st.markdown("**Name**")
    ...
    job_description = st.text_area("Describe the Job Profile", value=st.session_state['current_job_description'],height=150)
